...
import MCAnswer from "./Answers/MCAnswer";
export default function QuizEditor() {
  ...
  const [answerElements, setAnswerElements] = useState<JSX.Element[]>(answers.map((answer: any) => <MCAnswer def={answer} answers={answers} index={answers.length} setAnswers={setAnswers} setCorrect={setCorrect}></MCAnswer>));

  const addAnswerElement = (index: any) => {
    const newAnswerElement = <MCAnswer def={answers[index]} answers={answers} index={index} setAnswers={setAnswers} setCorrect={setCorrect}></MCAnswer>;
